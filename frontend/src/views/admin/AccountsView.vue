<template>
  <AppLayout>
                ...
                <Teleport to="body">
                  ...
                  >
                    <div class="overflow-y-auto p-2" :style="{ maxHeight: `${accountToolsDropdownPosition.maxHeight}px` }">
                      ...
                      <button class="account-tools-menu-item" @click="openBatchImport">
                        <span class="account-tools-menu-icon bg-teal-50 text-teal-600 dark:bg-teal-900/30 dark:text-teal-300">
                          <Icon name="upload" size="sm" />
                        </span>
                        <span class="flex-1 text-left">{{ t('admin.accounts.batchImport') }}</span>
                      </button>
    ...
    <BatchImportModal :show="showBatchImport" @close="showBatchImport = false" @imported="handleBatchImported" />
...
import BatchImportModal from '@/components/admin/account/BatchImportModal.vue'
...
const handleBatchImported = () => { showBatchImport.value = false; reload() }
const openBatchImport = () => { closeAccountToolsDropdown(); showBatchImport.value = true }
