export default {
    accounts: {
      ...
      batchImport: '导入凭据',
      batchImportTitle: '导入凭据',
      batchImportHint: '从 JSON 或 JSONL 文件导入 Anthropic、Gemini 或 Antigravity 凭据。',
      batchImportFiles: '凭据文件',
      batchImportSelectFiles: '选择一个或多个文件',
      batchImportFilesSelected: '已选择 {count} 个文件',
      batchImportButton: '开始导入',
      batchImporting: '导入中...',
      batchImportNoFiles: '请至少选择一个凭据文件',
      batchImportNoAccounts: '选中的文件中没有有效账号',
      batchImportTotalTooLarge: '选中的文件总大小超过 50 MB',
      batchImportResult: '导入结果',
      batchImportResultSummary: '创建 {created}，跳过 {skipped}，失败 {failed}',
      batchImportErrors: '错误',
      batchImportWarnings: '警告',
      batchImportErrorsTruncated: '共 {total} 个错误，仅显示前 100 个',
      batchImportSuccess: '已导入 {created} 个账号',
      batchImportAllSkipped: '已跳过 {skipped} 个已存在账号',
      batchImportCompletedWithErrors: '导入完成，{failed} 个账号失败',
      batchImportFailed: '凭据导入失败',
