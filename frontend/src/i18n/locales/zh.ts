export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      dataImportResultSummary: '代理创建 {proxy_created}，复用 {proxy_reused}，失败 {proxy_failed}；账号创建 {account_created}，跳过重复 {account_skipped}，失败 {account_failed}',
      ...
      batchImport: '批量导入',
      batchImportTitle: '批量导入账号',
      batchImportHint: '选择多个 JSON 文件批量导入账号，系统将自动识别文件格式。',
      batchImportFiles: '选择文件',
      batchImportSelectFiles: '请选择一个或多个 JSON 文件',
      batchImportFilesSelected: '已选择 {count} 个文件',
      batchImportButton: '开始导入',
      batchImporting: '导入中...',
      batchImportNoFiles: '请至少选择一个文件',
      batchImportNoAccounts: '未从文件中解析出有效账号',
      batchImportResult: '导入结果',
      batchImportResultSummary: '创建 {created}，跳过重复 {skipped}，失败 {failed}',
      batchImportErrors: '失败详情',
      batchImportSuccess: '批量导入完成：成功创建 {created} 个账号',
      batchImportAllSkipped: '全部 {skipped} 个账号已存在，已跳过导入',
      batchImportCompletedWithErrors: '批量导入完成，{failed} 个失败',
      batchImportFailed: '批量导入失败',
      batchImportWarnings: '跳过详情',
      batchImportTotalTooLarge: '文件总大小超过 50MB 限制',
      batchImportErrorsTruncated: '共 {total} 条警告，仅显示前 100 条',
