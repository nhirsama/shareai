export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      batchImportHint: 'Select multiple JSON files to import accounts in bulk. The system will auto-detect the format.',
      batchImportFiles: 'Select Files',
      batchImportSelectFiles: 'Select one or more JSON files',
      batchImportFilesSelected: '{count} file(s) selected',
      batchImportButton: 'Start Import',
      batchImporting: 'Importing...',
      batchImportNoFiles: 'Please select at least one file',
      batchImportNoAccounts: 'No valid accounts found in the selected files',
      batchImportResult: 'Import Result',
      batchImportResultSummary: 'Created {created}, skipped duplicates {skipped}, failed {failed}',
      batchImportErrors: 'Error Details',
      batchImportSuccess: 'Batch import completed: {created} account(s) created',
      batchImportAllSkipped: 'All {skipped} account(s) already exist, skipped import',
      batchImportCompletedWithErrors: 'Batch import completed with {failed} error(s)',
      batchImportFailed: 'Batch import failed',
      batchImportWarnings: 'Skipped Details',
      batchImportTotalTooLarge: 'Total file size exceeds 50MB limit',
      batchImportErrorsTruncated: '{total} warnings total, showing first 100',
